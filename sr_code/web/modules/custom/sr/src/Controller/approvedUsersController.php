...
/**
 * Controller for displaying approved users.
 *
 * @package Drupal\sr\Controller
 */
class approvedUsersController extends ControllerBase {

  /**
   * Displays a list of approved (active) users.
   */
  public function approvedUsers() {
    ...
    // Query to fetch approved (active) users.
    ...
    foreach ($users as $user) {
      ...
      // Add user details to the table rows.
      $rows[] = [
        'ID' => $user->id(),
    ...
    $table = [
      ...
      '#header' => $header,
      '#rows' => $rows,
      '#empty' => $this->t('No approved agents.'),
    ];
