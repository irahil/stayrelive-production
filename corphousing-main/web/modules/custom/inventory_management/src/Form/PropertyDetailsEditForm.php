...
class PropertyDetailsEditForm extends FormBase {
  ...
  if ($property && $property->bundle() === 'property') {
   ...
   // Policy
    ...
    $refundable_days = (int) $node->get('field_refundable_days')->value;
    ...
    $form['policy_info']['cancellation_info']['refundable_days'] = [
      ...
      '#min' => 1,
      '#step' => 1,
      '#default_value' => $refundable_days > 0 ? $refundable_days : 1,
      '#states' => [
        'visible' => [
    ...
    $early_checkout_days = (int) $node->get('field_early_checkout_days')->value;
    ...
    $form['policy_info']['early_checkout']['early_checkout_days'] = [
      ...
      '#min' => 1,
      '#step' => 1,
      '#default_value' => $early_checkout_days > 0 ? $early_checkout_days : 1,
      '#states' => [
        'visible' => [
